...
def calculateRFMscores(data, weight_recency=1, weight_frequency=1, weight_monetary=1):
    """
    Calculate a weighted RFM: recency, frequency, and monetary value for each customer
    
    @param data: a pandas dataframe
    @param weight_recency: bla
    @param weight_frequency: bla
    @param weight_monetary: bla
    
    @return Returns a pandas dataframe of amazing quality
    
    @raise keyError: Good luck with debugging
    """
